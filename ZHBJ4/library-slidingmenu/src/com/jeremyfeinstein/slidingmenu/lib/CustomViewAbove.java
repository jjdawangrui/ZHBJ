...
public class CustomViewAbove extends ViewGroup {
	...
	private void completeScroll() {
		...
		if (needPopulate) {
			// Done with scroll, no longer want to cache com.itheima.shop.zhbj4.bean.view drawing.
			setScrollingCacheEnabled(false);
	 ...
	 * @param checkV Whether the com.itheima.shop.zhbj4.bean.view v passed should itself be checked for scrollability (true),
	...
	public boolean dispatchKeyEvent(KeyEvent event) {
		// Let the focused com.itheima.shop.zhbj4.bean.view and/or our descendants get the key first
		return super.dispatchKeyEvent(event) || executeKeyEvent(event);
	}

	/**
	 * You can call this function yourself to have the scroll com.itheima.shop.zhbj4.bean.view perform
	 * scrolling from a key event, just as if the event had been dispatched to
	 * it by the com.itheima.shop.zhbj4.bean.view hierarchy.
	 *
