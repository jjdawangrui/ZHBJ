...
/**
 * A TitlePageIndicator is a PageIndicator which displays the title of left com.itheima.shop.zhbj4.bean.view
 * (if exist), the title of the current select com.itheima.shop.zhbj4.bean.view (centered) and the title of
 * the right com.itheima.shop.zhbj4.bean.view (if exist). When the user scrolls the ViewPager then titles are
 * also scrolled.
 */
public class TitlePageIndicator extends View implements PageIndicator {
    ...
    /**
     * Title text used when no title is provided by the com.itheima.shop.zhbj4.bean.adapter.
     */
    ...
    /** Left and right side padding for not active com.itheima.shop.zhbj4.bean.view titles. */
    ...
    public TitlePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        //Retrieve the colors to be used for this com.itheima.shop.zhbj4.bean.view and apply them.
     ...
     * (non-Javadoc)
     *
     * @see android.com.itheima.shop.zhbj4.bean.view.View#onDraw(android.graphics.Canvas)
     */
    @Override
    protected void onDraw(Canvas canvas) {
        ...
        //Verify if the current com.itheima.shop.zhbj4.bean.view must be clipped to the screen
        ...
        if (mCurrentPage > 0) {
            for (int i = mCurrentPage - 1; i >= 0; i--) {
                ...
                if (bound.left < leftClip) {
                    ...
                    //Except if there's an intersection with the right com.itheima.shop.zhbj4.bean.view
        ...
        if (mCurrentPage < countMinusOne) {
            for (int i = mCurrentPage + 1 ; i < count; i++) {
                ...
                if (bound.right > rightClip) {
                    ...
                    //Except if there's an intersection with the left com.itheima.shop.zhbj4.bean.view
     ...
     *            current bounds.
     * @param curViewWidth
     *            width of the com.itheima.shop.zhbj4.bean.view.
     */
    ...
    /**
     * Calculate the bounds for a com.itheima.shop.zhbj4.bean.view's title
     *
     * @param index
     * @param paint
     * @return
    ...
    public void setViewPager(ViewPager view) {
        ...
        if (view.getAdapter() == null) {
            throw new IllegalStateException("ViewPager does not have com.itheima.shop.zhbj4.bean.adapter instance.");
        }
        mViewPager = view;
